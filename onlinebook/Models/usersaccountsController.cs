...
namespace onlinebook.Models
{
    public class usersaccountsController : Controller
    {
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\User\\Documents\\mynewdb1.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
